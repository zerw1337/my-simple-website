            ...
            <div style={{ maxWidth: "1200px", margin: "2rem auto" }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{
                            ...
                            textShadow: "0 0 6px rgba(180,255,255,0.5), 0 0 12px rgba(4,198,233,0.3)",
                        }}>
                            БЛОГ
                        </h2>
                        <p style={{
                    ...
                    {[
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: sort === key
                                    ? "linear-gradient(90deg, rgba(4,198,233,0.8), rgba(180,255,255,0.7))"
                                    : "rgba(255,255,255,0.05)",
                                color: sort === key ? "#1f1f1f" : "#a0a0a0",
                                fontWeight: 600,
                                fontSize: "0.85rem",
                                cursor: "pointer",
                                transition: "all 0.25s ease",
                                boxShadow: sort === key ? "0 4px 12px rgba(4,198,233,0.3)" : "none",
                            }}
                        >
                            {label}
                        </button>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: activeCategory === null
                                ? "linear-gradient(90deg, rgba(4,198,233,0.8), rgba(180,255,255,0.7))"
                                : "rgba(255,255,255,0.05)",
                            color: activeCategory === null ? "#1f1f1f" : "#a0a0a0",
                            fontWeight: 600,
                            fontSize: "0.85rem",
                            cursor: "pointer",
                        }}
               ...
               C1050,20 1200,30 1200,30"
                ...
                {filteredPosts.length === 0 ? (
                    <p style={{ color: "rgb(100,130,160)", textAlign: "center", marginTop: "3rem" }}>
                        Постов не найдено
                    </p>
                ) : (
